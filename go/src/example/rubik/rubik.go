...
func moveU(rubik rubikobj) rubikobj {
	/* WITH TEST */
	// Rotate U Side
	posToChange := []string{"U1", "U2", "U3", "U6", "U9", "U8", "U7", "U4", "R1", "R4", "R7", "F1", "F2", "F3", "L3", "L6", "L9", "B7", "B8", "B9"}
	posNewVal := []string{"U7", "U4", "U1", "U2", "U3", "U6", "U9", "U8", "B7", "B8", "B9", "R7", "R4", "R1", "F1", "F2", "F3", "L9", "L6", "L3"}
...
func moveUP(rubik rubikobj) rubikobj {
	...
	posToChange := []string{"U1", "U2", "U3", "U6", "U9", "U8", "U7", "U4", "R1", "R4", "R7", "F1", "F2", "F3", "L3", "L6", "L9", "B7", "B8", "B9"}
	posNewVal := []string{"U3", "U6", "U9", "U8", "U7", "U4", "U1", "U2", "F3", "F2", "F1", "L3", "L6", "L9", "B9", "B8", "B7", "R1", "R4", "R7"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
func moveR(rubik rubikobj) rubikobj {
	/* WITH TEST */
	// Rotate R Side
	posToChange := []string{"R1", "R2", "R3", "R6", "R9", "R7", "R8", "R4", "B3", "B6", "B9", "D7", "D4", "D1", "F3", "F6", "F9", "U3", "U6", "U9"}
	posNewVal := []string{"R7", "R4", "R1", "R2", "R3", "R9", "R6", "R8", "U3", "U6", "U9", "B3", "B6", "B9", "D7", "D4", "D1", "F3", "F6", "F9"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
func moveRP(rubik rubikobj) rubikobj {
	...
	posToChange := []string{"R1", "R2", "R3", "R6", "R9", "R8", "R7", "R4", "B3", "B6", "B9", "D7", "D4", "D1", "F3", "F6", "F9", "U3", "U6", "U9"}
	posNewVal := []string{"R3", "R6", "R9", "R8", "R7", "R4", "R1", "R2", "D7", "D4", "D1", "F3", "F6", "F9", "U3", "U6", "U9", "B3", "B6", "B9"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
func moveL(rubik rubikobj) rubikobj {
	/* WITH TEST */
	// Rotate L Side
	posToChange := []string{"L1", "L2", "L3", "L6", "L9", "L7", "L8", "L4", "B1", "B4", "B7", "U1", "U4", "U7", "F1", "F4", "F7", "D3", "D6", "D9"}
	posNewVal := []string{"L7", "L4", "L1", "L2", "L3", "L9", "L6", "L8", "D9", "D6", "D3", "B1", "B4", "B7", "U1", "U4", "U7", "F7", "F4", "F1"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
func moveLP(rubik rubikobj) rubikobj {
	...
	posToChange := []string{"L1", "L2", "L3", "L6", "L9", "L8", "L7", "L4", "B1", "B4", "B7", "U1", "U4", "U7", "F1", "F4", "F7", "D3", "D6", "D9"}
	posNewVal := []string{"L3", "L6", "L9", "L8", "L7", "L4", "L1", "L2", "U1", "U4", "U7", "F1", "F4", "F7", "D9", "D6", "D3", "B7", "B4", "B1"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
func moveF(rubik rubikobj) rubikobj {
	/* WITH TEST */
	// Rotate F Side
	posToChange := []string{"F1", "F2", "F3", "F6", "F9", "F7", "F8", "F4", "L7", "L8", "L9", "U7", "U8", "U9", "R7", "R8", "R9", "D7", "D8", "D9"}
	posNewVal := []string{"F7", "F4", "F1", "F2", "F3", "F9", "F6", "F8", "D7", "D8", "D9", "L7", "L8", "L9", "U7", "U8", "U9", "R7", "R8", "R9"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
func moveFP(rubik rubikobj) rubikobj {
	...
	posToChange := []string{"F1", "F2", "F3", "F6", "F9", "F8", "F7", "F4", "L7", "L8", "L9", "U7", "U8", "U9", "R7", "R8", "R9", "D7", "D8", "D9"}
	posNewVal := []string{"F3", "F6", "F9", "F8", "F7", "F4", "F1", "F2", "U7", "U8", "U9", "R7", "R8", "R9", "D7", "D8", "D9", "L7", "L8", "L9"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
func moveB(rubik rubikobj) rubikobj {
	/* WITH TEST */
	// Rotate B Side
	posToChange := []string{"B1", "B2", "B3", "B6", "B9", "B8", "B7", "B4", "L1", "L2", "L3", "U1", "U2", "U3", "R1", "R2", "R3", "D1", "D2", "D3"}
	posNewVal := []string{"B7", "B4", "B1", "B2", "B3", "B6", "B9", "B8", "U1", "U2", "U3", "R1", "R2", "R3", "D1", "D2", "D3", "L1", "L2", "L3"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
func moveBP(rubik rubikobj) rubikobj {
	...
	posToChange := []string{"B1", "B2", "B3", "B6", "B9", "B8", "B7", "B4", "L1", "L2", "L3", "U1", "U2", "U3", "R1", "R2", "R3", "D1", "D2", "D3"}
	posNewVal := []string{"B3", "B6", "B9", "B8", "B7", "B4", "B1", "B2", "D1", "D2", "D3", "L1", "L2", "L3", "U1", "U2", "U3", "R1", "R2", "R3"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
func moveD(rubik rubikobj) rubikobj {
	/* WITH TEST */
	// Rotate D Side
	posToChange := []string{"D1", "D2", "D3", "D6", "D9", "D8", "D7", "D4", "B1", "B2", "B3", "L1", "L4", "L7", "R3", "R6", "R9", "F7", "F8", "F9"}
	posNewVal := []string{"D7", "D4", "D1", "D2", "D3", "D6", "D9", "D8", "R3", "R6", "R9", "B3", "B2", "B1", "F9", "F8", "F7", "L1", "L4", "L7"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
func moveDP(rubik rubikobj) rubikobj {
	...
	posToChange := []string{"D1", "D2", "D3", "D6", "D9", "D8", "D7", "D4", "B1", "B2", "B3", "L1", "L4", "L7", "R3", "R6", "R9", "F7", "F8", "F9"}
	posNewVal := []string{"D3", "D6", "D9", "D8", "D7", "D4", "D1", "D2", "L7", "L4", "L1", "F7", "F8", "F9", "B1", "B2", "B3", "R9", "R6", "R3"}
	rubik = rubikMove(rubik, posToChange, posNewVal)
	return rubik
}
